			...
			try
			{
				...
				else
				{
					...
					Url = AppTools.IsTabDark()
						? InitializePlayTube.WebsiteUrl + "/create_article?cookie=" + UserDetails.AccessToken + "&user_id=" + UserDetails.UserId + "&mode=night"
						: InitializePlayTube.WebsiteUrl + "/create_article?cookie=" + UserDetails.AccessToken + "&user_id=" + UserDetails.UserId + "&mode=day";

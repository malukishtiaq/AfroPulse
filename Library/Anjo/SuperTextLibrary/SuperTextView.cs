...
namespace PlayTube.Library.Anjo.SuperTextLibrary
{
	public class SuperTextView : TextView
	{
		...
		private void Init(Context context)
		{
			try
			{
				...
				SetPhoneModeColor(new Color(ContextCompat.GetColor(context, Resource.Color.Left_ModePhone_color)));
				SetEmailModeColor(new Color(ContextCompat.GetColor(context, Resource.Color.Left_ModeEmail_color)));
				SetHashtagModeColor(new Color(ContextCompat.GetColor(context, Resource.Color.Left_ModeHashtag_color)));
				SetUrlModeColor(new Color(ContextCompat.GetColor(context, Resource.Color.Left_ModeUrl_color)));
		...
		public void SetTextInfo(SuperTextView showMore)
		{
			try
			{
				if (showMore != null)
				{
					...
					showMore.SetPhoneModeColor(new Color(ContextCompat.GetColor(Context, Resource.Color.Left_ModePhone_color)));
					showMore.SetEmailModeColor(new Color(ContextCompat.GetColor(Context, Resource.Color.Left_ModeEmail_color)));
					showMore.SetHashtagModeColor(new Color(ContextCompat.GetColor(Context, Resource.Color.Left_ModeHashtag_color)));
					showMore.SetUrlModeColor(new Color(ContextCompat.GetColor(Context, Resource.Color.Left_ModeUrl_color)));
